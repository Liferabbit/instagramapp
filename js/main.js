$(document).ready(function() {
 ...
 function processImages(data) {
  ...
  for ( var i = 0; i <= 4; i++ ) {
    var big = data.data[i]
    var imageURL = big.images.standard_resolution.url
    var userData = big.user.username
    var userAvatar = big.user.profile_picture
    $('#images').append ('<img src="' + imageURL + '"><img src="' + userAvatar + '"><p>' + userData + '</p>');
  }
 }
 ...
 // console.log(hashtag)
  ...
  $('#search').click(function(){
      $('#images').empty();
      var sok = $('#hashtag').val(),
          url = 'https://api.instagram.com/v1/tags/' + sok + '/media/recent?access_token=10125130.1c90803.c42984fb71b14ea5af4f0dd94e3b0053&callback=?'
...
// #access_token=10125130.1c90803.c42984fb71b14ea5af4f0dd94e3b0053
/*
